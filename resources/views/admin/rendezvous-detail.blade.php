...
@section('content')
        ...
        <a href="/admin/liste-visiteurs.html" class="btn btn-sm btn-outline-secondary mb-3"><i class="bi bi-arrow-left me-1"></i>Retour</a>
        <div class="row g-3">
...
@section('scripts')
  <script>
    buildLayout({ role: 'admin', active: '/admin/liste-visiteurs.html', title: 'Détail du rendez-vous', subtitle: 'Mariama Koné' });
  </script>
@endsection
