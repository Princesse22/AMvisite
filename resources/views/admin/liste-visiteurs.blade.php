...
@section('content')
        ...
        <div class="am-table-card">
          <div class="am-table-header">
            ...
            <a href="/admin/enregistrer-visiteur.html" class="btn btn-sm btn-orange"><i class="bi bi-plus-lg me-1"></i>Nouveau visiteur</a>
          </div>
            ...
            <table class="table am-table align-middle">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="text-end"><a href="/admin/rendezvous-detail.html" class="am-action-btn view"><i class="bi bi-eye"></i></a> <button class="am-action-btn edit" data-demo-action="Modification du visiteur (démo)."><i class="bi bi-pencil"></i></button> <button class="am-action-btn delete" data-demo-action="Visiteur supprimé (démo)."><i class="bi bi-trash"></i></button></td>
                </tr>
                <tr>
...
@section('scripts')
  <script>
    buildLayout({ role: 'admin', active: '/admin/liste-visiteurs.html', title: 'Liste des visiteurs', subtitle: 'Tous les visiteurs enregistrés' });
  </script>
@endsection
