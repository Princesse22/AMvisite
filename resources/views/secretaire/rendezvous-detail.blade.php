...
@section('content')
        ...
        <a href="/secretaire/liste-visiteurs.html" class="btn btn-sm btn-outline-secondary mb-3"><i class="bi bi-arrow-left me-1"></i>Retour</a>
        <div class="row g-3">
...
@section('scripts')
  <script>
    buildLayout({ role: 'secretaire', active: '/secretaire/liste-visiteurs.html', title: 'Détail du rendez-vous', subtitle: 'Mariama Koné' });
  </script>
@endsection
