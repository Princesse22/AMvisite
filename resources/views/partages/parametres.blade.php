...
@section('scripts')
  <script>
    var role = new URLSearchParams(location.search).get('role') || 'superadmin';
    buildLayout({ role: role, active: 'parametres.html', title: 'Paramètres', subtitle: 'Configuration du système' });
  </script>
@endsection
